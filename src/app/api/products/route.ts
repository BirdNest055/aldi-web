...
export async function GET(req: NextRequest) {
  ...
  if (sp.get("minPrice") !== null) params.minPrice = Number(sp.get("minPrice"));
  if (sp.get("maxPrice") !== null) params.maxPrice = Number(sp.get("maxPrice"));
  if (sp.get("page")) params.page = Number(sp.get("page"));
  if (sp.get("pageSize")) params.pageSize = Number(sp.get("pageSize"));
  if (sp.get("sort")) params.sort = sp.get("sort") as ListProductsParams["sort"];
